...
def loadfile():
    ...
    pos=pd.read_excel('../data/pos.xls',header=None,index_col=None,error_bad_lines=False)
...
def word2vec_train(combined):
    ...
    model.train(combined,total_examples=21105,epochs=1)
    model.save('../data/1Word2vec_model.pkl')
